...
describe('List.vue', () => {
    ...
    //         console.log("result : " + list[list.length-1].teextContent)
    //         expect(list[list.length-1].teextContent).to.contain('수영')
    //         expect(list[list.length-1].teextContent).to.contain('스쿼시')
